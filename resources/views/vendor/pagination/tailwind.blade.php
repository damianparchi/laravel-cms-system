@if ($paginator->hasPages())
    <nav style="text-align: center" role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between">
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            <div>
                <p class="text-sm text-gray-700 leading-5" style="margin: 20px">
                    {!! __('Showing') !!}
